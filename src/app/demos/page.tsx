...
export default function DemosDirectoryPage() {
  ...
  const demos: DemoCard[] = [
    ...
    {
      id: "medpay",
      title: "1-Tap MedPay (Pediatrics & Oral Surgery)",
      category: "High-Margin Healthcare Beachhead",
      badgeColor: "bg-teal-100 text-teal-900 border-teal-200",
      urlPath: "/demos/medpay",
      targetAudience: "Southdale Pediatrics / Maxillofacial Surgery Practice Managers",
      valueProp: "Eliminate paper bills & guarantor PINs. Recover post-insurance patient copays ($30–$250) in 48 hours.",
      keyFeatures: [
        "Itemized post-insurance statement (Insurance paid $195, Patient owes $45)",
        "1-Tap Apple Pay with HSA / FSA Healthcare card badge",
        "Zero password, zero patient portal registration",
        "Reduces 60-day aging balances by over 70%",
      ],
      icon: Stethoscope,
    },
    {
